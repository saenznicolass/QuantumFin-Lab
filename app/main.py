...
def main():
    ...
    selected_tab = st.sidebar.radio("Select a tab:", ["Portfolio Optimization and Risk", "Option Pricing", "Model Comparison"])

    if selected_tab == "Portfolio Optimization and Risk":
